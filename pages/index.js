      ...
      <section className="HomeContainer__hero" id="home">
        ...
        <div className="HomeContainer__hero--left">
          <div className="HomeContainer__hero--header">
            <h1>WHERE</h1>
            <div className="HomeContainer__hero--dateBox">16-17 March 2023</div>
            <h1>
          ...
          <div className="HomeContainer__hero--footer">
            ...
            <p>
              Register for the HACK - Introducing GLITCH, the flagship hackathon
              and a collaboration between the Google Developer Student Clubs
              (GDSC) and the ACM & ACM-W chapters of Shiv Nadar Institution of
              Eminence. Participate to seize the opportunity to learn,
              collaborate and build meaningful projects alongside mentors from
              various disciplines.
            </p>
          </div>
        </div>
      ...
      <section className="HomeContainer__about" id="about">
        <div className="HomeContainer__about--left">
          ...
          <p>
            ...
            <span> Empowering through tech. </span> We will have three tracks on
            this theme. Come join us for a couple of days full of fun workshops,
            plenary lectures, social mixers, games and super cool merch! Open to
            everyone across the country, GLITCH is{" "}
            <span> beginner friendly </span>, and is{" "}
            <span> free to register! </span>
          </p>
          <p>
            Our hackathon is aimed at inviting individuals to come together and
            ideate end-to-end solutions for sustainable development, healthcare,
            security & privacy and productivity & utility. All participating
            teams will spend time developing applications with real-world
            applications. Students will also get a chance to network with
        ...
        <div className="HomeContainer__about--right">
          <div className="HomeContainer__about--qBox">
            ...
            <div className="HomeContainer__about--two">
              "Unleash your inner superhero and code your way to victory!"
            </div>
